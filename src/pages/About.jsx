    ...
    const teams = [
        {
            ...
            leader: '浦川千歌',
            subLeader: '中岡知優',
            description: '委員長局では、大学祭全体の統括や花火の手続き、駐車場の管理などを行っています。\n最高の大学祭を作れるよう局員で力を合わせて頑張ります。\n 是非、2日間の大学祭をお楽しみください！',
            img: iinnchou
        },
        {
            name: '会計局',
        ...
        },
        {
            ...
            leader: '沖本千幸',
            subLeader: '住吉官施',
            description: 'システム局では、大学祭のホームページの制作、出店者と実行委員会のやり取りをするシステムの管理を主に行っています。\nこの年の大学祭を最高に楽しいものにできるように、一生懸命サポートしていきますので、よろしくお願いします！',
            img: system
        },
        {
            name: '装飾局',
    ...
    return (
        <div className="about">
            ...
            <div className='about-description'>
                <p>大学祭実行委員会は9個の局に分かれて仕事を分担し、中心となって大学祭を盛り上げる活動をしています。</p>
                <p>ここではそれぞれの局がどのような仕事をしているか紹介しています。</p>
                        ...
                        <div className='team-container'>
                            <div className='team-main'>
                                <div className='team-member'>
                                    ...
                                    {team.subLeader && <h4>副局長：{team.subLeader}</h4>}
                                </div>
